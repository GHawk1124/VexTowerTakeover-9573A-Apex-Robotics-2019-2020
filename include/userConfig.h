...
#define MOTOR_STOPPING_AUTON HOLD // HOLD : BRAKE : COAST
#define MOTOR_STOPPING_DRIVE HOLD // HOLD : BRAKE : COAST
...
#define WHEEL_CIRCUM WHEEL_DIAMETER*3.14159265 // FLOAT
#define BOT_WIDTH 12.00 // FLOAT
#define BOT_LENGTH 12.00 // FLOAT
...
#define INTAKE_1_P vex::PORT12
#define INTAKE_2_P vex::PORT19
